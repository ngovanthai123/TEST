    ...
    public class Tren25 : Controller
    {
        ...
        public IActionResult Index(string timkiem, int? page = 0)
        {
            ...
            var dress = _context.Sanphams
                .Where(sp => sp.GiaBan >25000000 || sp.GiaKhuyenMai>0 &&  sp.GiaKhuyenMai > 25000000)
