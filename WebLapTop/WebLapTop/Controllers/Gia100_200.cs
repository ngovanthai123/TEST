    ...
    public class Gia100_200 : Controller
    {
        ...
        public IActionResult Index(string timkiem, int? page = 0)
        {
            ...
            var dress = _context.Sanphams
                .Where(sp => sp.GiaBan >= 100000 && sp.GiaBan <= 200000 || sp.GiaKhuyenMai>0 && sp.GiaKhuyenMai >= 100000 && sp.GiaKhuyenMai<= 200000)
