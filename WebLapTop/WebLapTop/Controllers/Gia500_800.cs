    ...
    public class Gia500_800 : Controller
    {
        ...
        public IActionResult Index(string timkiem, int? page = 0)
        {
            ...
            var dress = _context.Sanphams
                .Where(sp => sp.GiaBan > 500000 && sp.GiaBan <= 800000 || sp.GiaKhuyenMai>0 && sp.GiaKhuyenMai > 500000 && sp.GiaKhuyenMai<= 800000)
