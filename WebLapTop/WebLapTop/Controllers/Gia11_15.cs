    ...
    public class Gia11_15 : Controller
    {
        ...
        public IActionResult Index(string timkiem, int? page = 0)
        {
            ...
            var dress = _context.Sanphams
                .Where(sp => sp.GiaBan >= 11000000 && sp.GiaBan <= 15000000 || sp.GiaKhuyenMai>0 && sp.GiaKhuyenMai >= 11000000 && sp.GiaKhuyenMai<= 15000000)
