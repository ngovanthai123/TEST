    ...
    public class Gia200_300 : Controller
    {
        ...
        public IActionResult Index(string timkiem, int? page = 0)
        {
            ...
            var dress = _context.Sanphams
                .Where(sp => sp.GiaBan > 200000 && sp.GiaBan <= 300000 || sp.GiaKhuyenMai>0 && sp.GiaKhuyenMai > 200000 && sp.GiaKhuyenMai<= 300000)
