...
namespace WebLapTop.Controllers
{
    ...
    public class ChitiethoadonController : Controller
    {
        ...
        public ChitiethoadonController(WebLapTopContext context)
        {
            _context = context;
        }
        ...
        {
            var webLapTopContext = _context.Chitiethoadons.Include(c => c.IdhoaDonNavigation).Include(c => c.IdsanPhamNavigation);
